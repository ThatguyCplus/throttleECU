...
typedef enum {
  ACTION_NONE = 0,
  ACTION_MOTOR_STOP = 1,      // Cut motor immediately
  ACTION_RELAY_OFF = 2,       // Disable relay
  ACTION_ENTER_SAFE = 3,      // Full safe state lock
  ACTION_ATTEMPT_RECOVERY = 4 // Retry with watchdog kick
} SafeAction;
